...
from TFE.base import PersistenceDiagramFeatureExtractor
...
class TopologicalFeaturesExtractor:
    def __init__(self, persistence_diagram_features):
        self.persistence_diagram_features_ = persistence_diagram_features

    def fit_transform(self, persistence_diagram):
        X_transformed = None

        X_pd = persistence_diagram
